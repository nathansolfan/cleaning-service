<x-layout title="Create User">
    <h1 class="text-3xl font-bold text-blue-700 mb-4">Create User</h1>
    ...
    <form method="POST" action="{{ route('users.store') }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('users.index') }}" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Back to List</a>
        </div>
    </form>
</x-layout>
